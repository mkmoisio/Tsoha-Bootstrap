...
INSERT INTO Task(account_id, title, text, due) VALUES (1, 'Otsikko tässä', 'Selitekenttä tässä', NOW());
INSERT INTO Task(account_id, title, text, due) VALUES (1, '2 Otsikko2 tässä', 'Toinen task ekalle userille', NOW());
